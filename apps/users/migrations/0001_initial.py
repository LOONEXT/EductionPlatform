    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=50, verbose_name='\u7535\u5b50\u90ae\u4ef6')),
                ('send_type', models.CharField(choices=[('register', 'Register'), ('forget', 'Forget Password')], max_length=20, verbose_name='Code Type')),
